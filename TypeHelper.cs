...
namespace GitCloneFunction
{
    ...
    public static class TypeHelper
    {
        ...
        /// <returns>A string representing the type's names and values</returns>
        public static string GetTypes<T>(T data, List<string> propertiesToExclude)
        {
            ...
            foreach (PropertyInfo i in props)
            {
                ...
                {
                    sb.AppendLine($"{i.Name}: {i.GetValue(data, null)}");
                }
            }
        ...
        /// <returns>A string representing the types names and values</returns>
